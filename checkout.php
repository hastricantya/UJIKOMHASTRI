...
<html>
<head>
<title>HASMED - Bayar Sekarang</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>BELANJA SEKARANG DAN DAPATKAN ALAT KESEHATAN PREMIUM!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62) 7777777</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">HASMED</a></h1>
			</div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1">
				<li><a href="index.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Rumah</a></li>
				<li class="active">Bayar Sekarang</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di HASMED</span></h1>
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp100.000</h2>
		...
		<br>
		<form method="post">
		<input type="submit" class="form-control btn btn-success" name="checkout" value="Saya setuju dan akan melakukan pembayaran" \>
		<br>
		<br>
		<a href="unduhbukti.php"><input type= "button" class="form-control btn btn-success" name="email" value="Pelanggan Wajib Unduh Bukti Pembelian! Klik Disini"\></a>
		</form>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
					<<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>HASMED, Bandung</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">hasmed@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+62) 7777777</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					...
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Kontak Kami</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 HASMED. All rights reserved</p>
			</div>
		</div>
	...
	<div class="footer-botm">
			<div class="container">
				<div class="w3layouts-foot">
					<ul>
						<li><a href="https://www.instagram.com/hastricantya_/" class="w3_agile_instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
